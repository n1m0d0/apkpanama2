...
public class adapter_list2 extends BaseAdapter {
    protected Activity activity;
    protected ArrayList<obj_params2> items;

    public adapter_list2(Activity activity, ArrayList<obj_params2> items) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            vi = inflater.inflate(R.layout.personalization6, null);
